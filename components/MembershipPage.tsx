    ...
    <div className="pt-24 md:pt-32 pb-20 bg-black min-h-screen relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12 md:mb-16 animate-fade-in-up">
            <h2 className="text-brand-red font-bold tracking-widest mb-2 text-xs md:text-sm">JOIN THE CLUB</h2>
            <h3 className="text-3xl md:text-6xl font-black uppercase italic text-white mb-6">Invest In Yourself</h3>
          ...
          {/* Perks Grid */}
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-16 md:mb-20 max-w-6xl mx-auto">
             <div className="bg-zinc-900/50 p-6 md:p-8 border border-zinc-800 rounded-lg text-center hover:border-brand-red transition-colors group animate-fade-in">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-black rounded-full mx-auto mb-4 md:mb-6 flex items-center justify-center text-brand-red group-hover:bg-brand-red group-hover:text-white transition-colors">
                   <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </div>
                <h4 className="text-lg md:text-xl font-bold uppercase text-white mb-2">24/7 Access</h4>
                <p className="text-zinc-400 text-sm md:text-base">Train on your terms. Early morning or late night, the iron is always waiting.</p>
             </div>
             ...
             <div className="bg-zinc-900/50 p-6 md:p-8 border border-zinc-800 rounded-lg text-center hover:border-brand-red transition-colors group animate-fade-in delay-200">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-black rounded-full mx-auto mb-4 md:mb-6 flex items-center justify-center text-brand-red group-hover:bg-brand-red group-hover:text-white transition-colors">
                   <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                </div>
                <h4 className="text-lg md:text-xl font-bold uppercase text-white mb-2">Free Consultation</h4>
                <p className="text-zinc-400 text-sm md:text-base">Every new member gets a 30-min strategy session with a lead trainer.</p>
             </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto mb-16">
            {/* Weekly Plans */}
            <div className="bg-black border-2 border-brand-red p-6 md:p-10 flex flex-col relative shadow-2xl shadow-red-900/20 transform md:hover:-translate-y-2 transition-transform animate-fade-in-up">
              <div className="absolute top-0 right-0 bg-brand-red text-white text-[10px] md:text-xs font-bold uppercase px-3 md:px-4 py-1">Most Popular</div>
              <h4 className="text-2xl md:text-3xl font-black uppercase italic text-white mb-4">Weekly Plans</h4>
              <div className="mb-6">
                <span className="text-zinc-500 font-bold block text-xs md:text-sm mb-1">Starting at</span>
                <span className="text-4xl md:text-6xl font-black text-brand-red">$9.99</span>
                <span className="text-zinc-500 font-bold uppercase text-xs md:text-sm">/ week</span>
              </div>
              ...
              <ul className="space-y-3 md:space-y-4 flex-1 mb-8">
                <li className="flex items-start gap-3 text-white font-bold text-sm md:text-base"><span className="text-brand-red">✓</span> 12 Month Contract @ $9.99/wk</li>
                <li className="flex items-start gap-3 text-white font-bold text-sm md:text-base"><span className="text-brand-red">✓</span> No Contract Option @ $13.49/wk</li>
                <li className="flex items-start gap-3 text-white font-bold text-sm md:text-base"><span className="text-brand-red">✓</span> 24/7 Access to Both Locations</li>
                <li className="flex items-start gap-3 text-white font-bold text-sm md:text-base"><span className="text-brand-red">✓</span> Free PT Session Included</li>
              </ul>
              <button onClick={() => onJoinClick('weekly')} className="w-full py-4 bg-brand-red text-white font-black uppercase hover:bg-red-600 transition-colors shadow-lg text-sm md:text-base">View Weekly Options</button>
            </div>
