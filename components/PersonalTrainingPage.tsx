              ...
              >
                <div className="aspect-[3/4] overflow-hidden">
                  <img 
                    src={trainer.image} 
                    alt={trainer.name} 
                    className={`w-full h-full object-cover transition-transform duration-700 group-hover:grayscale-0 grayscale ${trainer.id === 'george-gori' ? 'scale-100 group-hover:scale-110' : 'scale-125 group-hover:scale-[1.35]'}`}
                  />
                </div>
